    ...
    <section className="bg-gray-950 py-20 px-6 text-white">
      <div className="mx-auto max-w-6xl">
        <div className="bg-gray-900/70 border border-white/10 rounded-2xl p-4 sm:p-6 lg:p-8 backdrop-blur flex flex-col items-center">
          ...
          <p className="text-gray-400 mb-4">{t("contact.subtitle")}</p>
          <button
            onClick={fireConfetti}
            className="flex px-6 py-3 rounded-xl bg-violet-600 text-white font-medium transition hover:shadow-[0_0_40px_rgba(139,92,246,0.25)] hover:scale-104  active:scale-95 border-none outline-none gap-2 items-center justify-center cursor-pointer "
          >
            {" "}
            <LucideMessageSquareText /> {t("contact.button")}
          </button>
        </div>
      </div>
    </section>
